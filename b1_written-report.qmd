...
*We displayed our results visually using box and whisker plots, with separate plots for California and Vermont. Each plot shows the distribution of age within the state, with the y-axis representing age and the x-axis unlabeled since only one variable is measured. These plots highlight the central tendency, spread, and skewness of the age data, making differences between the states clear.*
